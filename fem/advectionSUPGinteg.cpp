...
namespace mfem
{
void VectorAdvectionIntegrator::AssembleElementVector(
...
void VectorAdvectionIntegrator::StabConvectionIntegrator(
...
void VectorAdvectionIntegrator::ConvectionIntegrator(const FiniteElement &el,
...
void VectorAdvectionIntegrator::StabConvGradIntegrator(const FiniteElement &el,
                                    ElementTransformation &Tr,
                                    DenseMatrix &elmat)
{
    int dim = el.GetDim() + 1;
...
void VectorAdvectionIntegrator::StabLapConvIntegrator(
                                  const FiniteElement &el,
                                  ElementTransformation &Tr, 
                                  DenseMatrix &elmat)
{
...
void VectorAdvectionIntegrator::StabLapGradIntegrator(
                                    const FiniteElement &el, 
                                    ElementTransformation &Tr, 
                                    DenseMatrix &elmat)
{
...
void VectorAdvectionIntegrator::StabLapLapIntegrator(
                                    const FiniteElement &el,
                                    ElementTransformation &Tr,
                                    DenseMatrix &elmat)
{
...
void VectorAdvectionIntegrator::StabLaplacianIntegrator(
                                    const FiniteElement &el, 
                                    ElementTransformation &Trans, 
                                    DenseMatrix &elmat)
{
...
void VectorAdvectionIntegrator::SatbDivIntegrator(const FiniteElement &el,
                                                    ElementTransformation &Tr,
                                                    DenseMatrix &elmat)
{
   int dim = el.GetDim() + 1; //1 is for pressure 
...
void VectorAdvectionIntegrator::StabVecAdvIntegrator(const FiniteElement &el,
...
void VectorAdvectionIntegrator::StabVecGradIntegrator(const FiniteElement &el,
                                      ElementTransformation &Tr, Vector &elvect)
{
   double norm;
...
void VectorAdvectionIntegrator::StabVecLapIntegrator(const FiniteElement &el,
                                      ElementTransformation &Tr, Vector &elvect)
{
   double norm;
...
void VectorAdvectionIntegrator::CalculateTaus(const double nu, 
...
void VectorAdvectionIntegrator::CalcPhysLaplacian(DenseMatrix &Hessian, 
                                                    double nnodes,
                                                    double spaceDim,        
                                                    Vector& Laplacian)
{
...
VectorAdvectionIntegrator::~VectorAdvectionIntegrator()
{
